...
onMounted(async () => {
    await employeeService.getEmployeeById(Number(props.id));
...
const DeleteDoc = async () => {
    ...
    await employeeService.DeleteDocEmployee(rhStore.ItemId).then(() => {
...
<template>
    <div class="flex-grow-1 container-fluid mt-3">
        ...
        <div v-if="employee" class="row ">
            ...
            <div class="col-xl-8 col-lg-7 col-md-7">
                                    ...
                                    <div class="card-body" @mouseover="showSalary = true"
                                        ...
                                        <h6 v-if="showSalary" class="mb-1 fw-bold">
                                            <small>Salaire par jour :
                                                {{ formater.number(employee.salary_per_day) }}
                                                MAD</small>
                                        </h6>
                ...
                'N/A'
                                            ...
                                            <div v-if="employee.copie_rib">
                                                <a :href="getFileUrl(employee.copie_rib)" target="_blank">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div v-if="employee.copie_cnss != null" class="card mt-4 border shadow-none">
                                            <div class="card-body p-2">
                                                <a :href="getFileUrl(employee.copie_cnss)" target="_blank" class="d-flex align-items-center">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <table class="table">
                                ...
                                <tbody v-if="employee.histsalary != 0">
                                    <tr v-for="item in employee.histsalary" :key="item.id">
                                        <td>
                                            {{ formater.number(item.salary) }} MAD
                                        </td>
                                        <td class="text-center">
                                            {{ formater.number(item.salary / 26) }} MAD
                                        </td>
                                        <td class="text-center">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <table class="table">
                                ...
                                <tbody v-if="employee.leaves != 0">
                                    <tr v-for="item in employee.leaves" :key="item.id">
                                        <td>
                                            {{ formater.date(item.start_date) }}
                                        </td>
                                        <td class="text-center">
                                            {{ formater.date(item.end_date) }}
                                        </td>
                                        <td class="text-center">
                                            {{ item.duration ?
                                            item.duration > 1 ? item.duration + ' Jours' :
                                            item.duration + ' Jour' : 'N/A' }}
                                        </td>
                                        <td class="text-center">
            ...
            <EditLeavePerMonthModal :id="employee.id" :old-day-per-month="employee.solde_conge" />
