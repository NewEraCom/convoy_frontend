...
const submit = async () => {
    ...
    await employeeService.addEmployee(formData.value).then(() => {
        ...
        <form @submit.prevent="submit" enctype="multipart/form-data">
            <div class="modal-body">
                <div class="row">
                    <div class="col-sm-12">
                        <div class="mb-3">
                            <label for="nom" class="form-label">Matricule
                                <span class="text-danger">*</span>
                            </label>
                            <input id="nom" v-model="formData.matricule" class="form-control"
                                placeholder="Entrez la matricule" type="text" tabindex="0" autofocus required />
                        </div>
                    </div>
                    <div class="col-sm-6">
                        <div class="mb-3">
                    ...
                    <div v-if="formData.type_contrat == 'CDD'" ß class="col-sm-12">
                        <div class="mb-3">
                            ...
                            <input id="duree" v-model="formData.duree_contract" class="form-control"
                    ...
                    <div class="col-sm-8">
                        <div class="mb-3">
                            ...
                            <input id="adresse" v-model="formData.adress" class="form-control"
                    ...
                    <div class="col-sm-6">
                        <div class="mb-3">
                            ...
                            <select id="sexe" v-model="formData.type_account" class="form-select" required>
                                <option value="-" disabled>Selectionner le type de compte</option>
                                <option value="portal">Compte Employee</option>
                                <option value="erp">Compte ERP</option>
                            </select>
                        </div>
                    </div>
                    <div class="col-sm-6">
                        <div class="mb-3">
                            ...
                            <select id="sexe" v-model="formData.role" class="form-select" required>
                                <option value="Human Resource">Responsable Ressources Humaines</option>
                                <option value="Logistics"> Responsable Logistic</option>
                                <option value="IT">IT</option>
                                <option value="Marketing">Responsable commercial</option>
                                <option value="Sales">Responsable achat</option>
                                <option value="Responsable Avant Projet">Responsable avant projet</option>
                                <option value="Director Business Development">Directeur Business Developement</option>
                                <option value="Employee">Employe</option>
                                <option value="Project Manager">Chef dr projet</option>
                                <option value="Supervisor">Directeur Operation</option>
                                <option value="Director">Directeur Support</option>
                                <option value="CEO">Directeur general</option>
