...
import EditFournisseur from '../Modals/EditFournisseur.vue'
...
const soustraitant = ref(computed(() => sharedStore.fournisseurs.data));
console.log(soustraitant)
onMounted(async () => {
    await SousTraitantService.getSousTraitantById(props.id);
...
const getFileUrl = (attachment) => {
    return helpers.baseUrl() + `uploads/tiers/${attachment}`;
};
...
<template>
    <div class="flex-grow-1 container-fluid mt-3" v-if="soustraitant">
        ...
        helpers.returnBadge(String(soustraitant.is_active))[1]
                        ...
                        <div class="info-container">
                            <ul class="list-unstyled">
                                ...
                                <li class="mb-2 pt-1" v-if="soustraitant.num_cnss">
                                    ...
                                    <span>{{ getValueOrDefault(soustraitant.num_cnss) }}</span>
                                </li>
                                

                                <li class="mb-2 pt-1" v-if="soustraitant.num_rc !== null">
            ...
            <EditFournisseur :soustraitant="soustraitant" />
        </div>
    </div>
