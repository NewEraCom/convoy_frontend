...
const submit = async () => {
  ...
  try {
    await sharedService.createEvent(formData).then((res) => {
      if (res.status === 200) {
    ...
    <form @submit.prevent="submit">
      <div class="modal-body">
        <div class="row">
          ...
          <div class="col-12">
            <div class="mb-3">
              <label for="eventDate" class="form-label"
                >Date d'événement <span class="text-danger">*</span>
              </label>
          ...
          <div class="col-6">
            <div class="mb-3">
              <label for="evenetDateStart" class="form-label"
          ...
          <div class="col-12">
            <div class="mb-3">
              <label for="eventComment" class="form-label"
