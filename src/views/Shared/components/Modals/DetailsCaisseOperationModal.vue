...
const selectedOperation = ref(computed(() => SharedStore.selectedItem));
    ...
    <Modal id="detailsOperation" title="Détails de l'opération" size="modal-lg">
        <div v-if="selectedOperation" class="modal-body">
            <div class="row">
                ...
                <div class="col-md-12 mb-3">
                    <label for="type" class="mb-2">Date d'opération</label>
                    <input type="text" class="form-control fw-bold"
        ...
        <div class="modal-footer">
            ...
            v-if=" selectedOperation && selectedOperation.status == 'demande' && role == 'Logistics'">Imprimer le recu</button>
