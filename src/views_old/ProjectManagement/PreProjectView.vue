...
import { PreProjectTable, NewPreProjectModal, ImportationPreProjectModal } from './components';
...
<template>
  <div class="flex-grow-1 container-fluid mt-3">
    ...
    <Modal id="import-avantprojet" title="Importation Avant Projet" size="modal-md">
      <ImportationPreProjectModal />
    </Modal>
