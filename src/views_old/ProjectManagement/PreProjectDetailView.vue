...
<template>
  <div v-if="preProject != null" class="flex-grow-1 container-fluid mt-3">
    ...
    <DeleteDocModal id="deleteArticle" :isLoading="isLoading" :method="deleteArticles" :itemid="PMStore.ItemId"
      title="Supprimer l'Article" message="Êtes-vous sûr de supprimer cet article ?" />
  </div>
